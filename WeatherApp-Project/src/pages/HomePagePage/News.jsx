...
const videoIds = [
  "i2_O9xfxPbk", "fBZJdbw9SnQ", "k5jWi6eR_6s",
  "Wzf07xXjlCk", "8GNQ3rh2jUE", "vTPIKPn4xA4"
];
...
export const News = React.memo(() => {
  ...
  // Dùng useCallback để hàm không bị tạo lại
  const handleOnPlay = useCallback((currentId) => {
